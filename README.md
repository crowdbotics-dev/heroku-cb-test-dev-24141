...
## Project Structure
    ...
    ├── heroku_cb_test_dev_24141  # Django project configurations
...
1. Clone this repo and `cd heroku_cb_test_dev_24141`
...
2. Clone this repo and `cd heroku_cb_test_dev_24141`
